...
c-opt-test: src/New/hash-table-c-chain-opt.c tests/New/hash-table-c-chain-test-opt.c
	$(CC) $(CFLAGS) src/New/hash-table-c-chain-opt.c tests/New/hash-table-c-chain-test-opt.c -o c-opt-test

# x86 implementation(new)
asm-opt-test: src/New/hash-table-asm-chain-opt.s src/New/hash-table-c-chain-opt.c tests/New/hash-table-asm-chain-test-opt.c
	$(CC) $(ASM_FLAGS) src/New/hash-table-asm-chain-opt.s src/New/hash-table-c-chain-opt.c tests/New/hash-table-asm-chain-test-opt.c -o asm-opt-test
