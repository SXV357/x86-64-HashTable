...
struct WordTableFuncs {
    ...
    long (*table_lookup) (void * table, char * word, long * value);
    long (*table_update) (void * table, char * word, long value);
    // TO DO: add field here for delete function as well
    void (*table_print) ();
};
...
void HashTable_C_print() {
    // TO DO
}

bool HashTable_C_delete() {
    // TO DO
    return false;
}